package com.crystal.aplayer.module_base.common.util.callback
...
class ViewPagerChangeListener(private val viewPager: ViewPager2, private var defaultPosition: Int, private val itemPlayId: Int) : ViewPager2.OnPageChangeCallback() {
    /**
    ...
    override fun onPageScrolled(position: Int, positionOffset: Float, positionOffsetPixels: Int) {
        ...
        LogUtil.d(TAG, "onPageSelected>>>position:${position},positionOffsetPixels:${positionOffsetPixels}")
