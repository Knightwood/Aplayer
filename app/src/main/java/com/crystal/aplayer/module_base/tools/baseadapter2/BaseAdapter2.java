package com.crystal.aplayer.module_base.tools.baseadapter2;
 ...
 * 描述：
 */
public final class BaseAdapter2<T, N extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<N> {
    protected List<T> list = null;//T类型的bean的list集合
    protected ViewHolderControl<T> viewHolderControl;
    private static final String TAG = "BASEADAPTER";

    public BaseAdapter2(List<T> list) {
        this.list = list;
    }

    public BaseAdapter2(List<T> list, @NonNull ViewHolderControl<T> viewHolderControl) {
        this.list = list;
